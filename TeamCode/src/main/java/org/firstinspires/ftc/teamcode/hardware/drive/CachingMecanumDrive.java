 ...
 */
public class CachingMecanumDrive extends RobotDrive {
    private double rightSideMultiplier;

    CachingDcMotorEx[] motors;
    ...
    public CachingMecanumDrive(
        ...
        motors = new CachingDcMotorEx[]{frontLeft, frontRight, backLeft, backRight};
