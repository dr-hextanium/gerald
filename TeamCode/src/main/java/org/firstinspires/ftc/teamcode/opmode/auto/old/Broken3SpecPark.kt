...
@Disabled
@Autonomous(name = "Broken 3 Spec + Park")
class Broken3SpecPark : BaseTemplate() {
	...
	override fun start() {
		Robot.scheduler.schedule(
			...
			SequentialCommandGroup(
				...
				GoToPointTimed(Pose2D(19.0, -24.0, 0.0), 1000, 1.1),
...
//				GoToPointTimed(Pose2D(24.0, 10.0, 0.0), 1000, 0.8),
				...
				ParallelCommandGroup(
					GoToPointTimed(Pose2D(40.0, 24.0, 0.0), 2000, 0.9),
					SequentialCommandGroup(
						WaitCommand(1300),
						ScoreSpecimen(),
					)
				...
				GoToPointTimed(Pose2D(14.0, -50.0, 0.0), 3000, 1.1),
			)
		)
	}
