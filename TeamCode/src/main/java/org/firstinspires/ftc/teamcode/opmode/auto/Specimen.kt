	...
	override fun start() {
		...
		Robot.scheduler.schedule(
			...
			SequentialCommandGroup(
				ParallelCommandGroup(
					// score the first one
					GoToPointTimed(Pose2D(0.0, 24.5, 0.0), 1500),
					PrepScoringSpecimen(),
				),
...
//				GoToPointTimed(Pose2D(0.0, -12.0, 0.0), 2000),
//
//				WaitCommand(1000),
//
//				GoToPointTimed(Pose2D(5.0, -12.0, 0.0), 2000),
...
////
//				// grab
//				GoToPointTimed(Pose2D(28.0, -2.0, 0.0), 1000),
//				GoToPointTimed(Pose2D(28.0, 3.0, 0.0), 2000),
//				PrepScoringSpecimen(),
//				WaitCommand(500),
//
//				GoToPointTimed(Pose2D(7.0, -5.0, 0.0), 2000),
//				GoToPointTimed(Pose2D(-6.0, -33.0, 0.0), 1000),
//				WaitCommand(500),
//				ScoreSpecimen(),
			)
		)
