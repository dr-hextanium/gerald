...
*/
@TeleOp
class SensorSparkFunOTOSKt : LinearOpMode() {
	// Create an instance of the sensor
	lateinit var myOtos: SparkFunOTOS

	@Throws(InterruptedException::class)
	override fun runOpMode() {
		// Get a reference to the sensor
		myOtos = hardwareMap.get(SparkFunOTOSCorrected::class.java, "otos")
	...
	private fun configureOtos() {
		...
		myOtos!!.linearUnit = DistanceUnit.INCH
		// myOtos.setAngularUnit(AnguleUnit.RADIANS);
		myOtos!!.angularUnit = AngleUnit.DEGREES
		...
		val offset = SparkFunOTOS.Pose2D(-1.625, 0.0, 0.0)
		myOtos!!.offset = offset
		...
		myOtos!!.position = currentPosition
