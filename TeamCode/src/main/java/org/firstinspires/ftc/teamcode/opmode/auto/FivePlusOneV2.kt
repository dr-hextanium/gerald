...
import org.firstinspires.ftc.teamcode.paths.FivePlusOnePathsV2

@Autonomous(name = "5 Specimen 1 Sample V2")
class FivePlusOneV2 : AutoTemplate(FivePlusOnePathsV2.startPose) {
